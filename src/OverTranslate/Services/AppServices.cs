...
internal static class AppServices
{
    ...
    /// <summary>
    /// Local speech recognition for 系統音訊翻譯. Construction is cheap for the same reason as
    /// <see cref="Ocr"/> — the Whisper model loads lazily on first segment, and reloads only if the
    /// user changes <see cref="Models.AudioSettings.ModelSize"/> mid-session.
    /// </summary>
